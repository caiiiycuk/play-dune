/* $Id: gui.h 2499 2011-08-31 11:55:43Z truebrain $ */
...
extern uint16 Async_GUI_DisplayModalMessage(char *str, uint16 stringID, ...);
...
extern void Async_GUI_EndStats_Show(uint16 killedAllied, uint16 killedEnemy, uint16 destroyedAllied, uint16 destroyedEnemy, uint16 harvestedAllied, uint16 harvestedEnemy, int16 score, uint8 houseID);
...
extern void Async_GUI_StrategicMap_Show(uint16 campaignID, bool win);
