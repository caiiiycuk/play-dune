/* $Id: load.c 2539 2011-10-17 13:29:25Z glx $ */
...
static bool Load_Main(FILE *fp)
{
	...
	if (version != 0x0290) {
		...
		Async_GUI_DisplayModalMessage(String_Get_ByIndex(STR_WARNING_ORIGINAL_SAVED_GAMES_ARE_INCOMPATABLE_WITH_THE_NEW_VERSION_THE_BATTLE_WILL_BE_RESTARTED), 0xFFFF);
